...
const PosModals = () => {
  ...
  const [selectedWeightUnit, setSelectedWeightUnit] = useState<string | null>(null);
  ...
  const [selectedDiscountMode, setSelectedDiscountMode] = useState<string | null>(null);
  ...
  return (
    <>
      ...
      {/* /Payment Completed */}
      {/* Print Receipt */}
      <div className="modal fade modal-default" id="print-receipt" aria-labelledby="print-receipt">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
      ...
      {/* Hold */}
      <CustomerModal />
      <div className="modal fade modal-default pos-modal" id="hold-order" aria-labelledby="hold-order">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
            ...
            <form>
              <div className="modal-body">
                ...
                <div className="mb-3">
                  ...
                  <input className="form-control" type="text" defaultValue="" placeholder="" />
                </div>
                <p>
                  The current order will be set on hold. You can retreive this order from the pending order button. Providing a reference to
      ...
      {/* /Hold */}
      {/* Edit Product */}
      <div className="modal fade modal-default pos-modal" id="edit-product" aria-labelledby="edit-product">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="mb-3">
                      ...
                      <input type="text" className="form-control" defaultValue="Red Nike Laser Show" />
                    </div>
                  </div>
                  <div className="col-lg-6 col-sm-12 col-12">
                    <div className="mb-3">
                      ...
                      <div className="input-icon-start position-relative">
                        ...
                        <input type="text" className="form-control" defaultValue={1800} />
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-6 col-sm-12 col-12">
                    <div className="mb-3">
                      ...
                      <CommonSelect
                        ...
                        onChange={(e: any) => setSelectedTaxType(e.value)}
      ...
      {/* /Edit Product */}
      {/* Delete Product */}
      <div className="modal fade modal-default" id="delete" aria-labelledby="payment-completed">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-body p-0">
              <div className="success-wrap text-center">
                <form>
                  ...
                  <p className="fs-16 mb-3">The current order will be deleted as no payment has been made so far.</p>
                  <div className="d-flex align-items-center justify-content-center gap-2 flex-wrap">
                    <button type="button" className="btn btn-md btn-secondary" data-bs-dismiss="modal">
                      No, Cancel
                    </button>
      ...
      {/* /Delete Product */}
      {/* Reset */}
      <div className="modal fade modal-default" id="reset" aria-labelledby="payment-completed">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-body p-0">
              <div className="success-wrap text-center">
                <form>
                  ...
                  <p className="fs-16 mb-3">
                    The current order will be cleared. But not deleted if it&apos;s persistent. Would you like to proceed ?
                  </p>
                  <div className="d-flex align-items-center justify-content-center gap-2 flex-wrap">
                    <button type="button" className="btn btn-md btn-secondary" data-bs-dismiss="modal">
                      No, Cancel
      ...
      {/* /Reset */}
      {/* Recent Transactions */}
      <div className="modal fade pos-modal" id="recents" tabIndex={-1} aria-hidden="true">
        <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-header">
                ...
                <div className="tab-content">
                  <div className="tab-pane fade show active" id="onhold" role="tabpanel" aria-labelledby="onhold-tab">
                    ...
                    <div className="order-body">
                      <div className="card bg-light mb-3">
                        <div className="card-body">
                          <span className="badge bg-dark fs-12 mb-2">Order ID : #45698</span>
                          <div className="row g-3">
                            <div className="col-md-6">
                              <p className="fs-15 mb-1">
                                <span className="fs-14 fw-bold text-gray-9">Cashier :</span> admin
                              </p>
                              <p className="fs-15">
                                <span className="fs-14 fw-bold text-gray-9">Total :</span> $900
                              </p>
                            </div>
                            <div className="col-md-6">
                              <p className="fs-15 mb-1">
                                <span className="fs-14 fw-bold text-gray-9">Customer :</span> Botsford
                              </p>
                              <p className="fs-15">
                                <span className="fs-14 fw-bold text-gray-9">Date :</span> 24 Dec 2024 13:39:11
                              </p>
                            </div>
                          </div>
                          <div className="bg-info-transparent p-1 rounded text-center my-3">
                            <p className="text-info fw-medium">Customer need to recheck the product once</p>
                          </div>
                      ...
                      <div className="card bg-light mb-0">
                        <div className="card-body">
                          <span className="badge bg-dark fs-12 mb-2">Order ID : #666659</span>
                          <div className="mb-3">
                            <div className="row g-3">
                              <div className="col-md-6">
                                <p className="fs-15 mb-1">
                      ...
                      <div className="card bg-light mb-3">
                        <div className="card-body">
                          ...
                          <div className="row g-3">
                            ...
                            <div className="col-md-6">
                              <p className="fs-15 mb-1">
                                <span className="fs-14 fw-bold text-gray-9">Customer :</span> Anastasia
                              </p>
                              <p className="fs-15">
                                <span className="fs-14 fw-bold text-gray-9">Date :</span> 24 Dec 2024 13:39:11
                              </p>
                      ...
                      <div className="card bg-light mb-0">
                        <div className="card-body">
                          ...
                          <div className="row g-3">
                            ...
                            <div className="col-md-6">
                              <p className="fs-15 mb-1">
                                <span className="fs-14 fw-bold text-gray-9">Customer :</span> Lucia
                              </p>
                              <p className="fs-15">
                                <span className="fs-14 fw-bold text-gray-9">Date :</span> 24 Dec 2024 13:39:11
                              </p>
                        ...
                        <div className="card-body">
                          ...
                          <div className="row g-3">
                            <div className="col-md-6">
                              ...
                              <p className="fs-15">
                                <span className="fs-14 fw-bold text-gray-9">Total :</span> $1000
                              </p>
                            </div>
                            <div className="col-md-6">
                              <p className="fs-15 mb-1">
                                <span className="fs-14 fw-bold text-gray-9">Customer :</span> Hugo
                              </p>
                              <p className="fs-15">
                                <span className="fs-14 fw-bold text-gray-9">Date :</span> 24 Dec 2024 13:39:11
                              </p>
                        ...
                        <div className="card-body">
                          ...
                          <div className="row g-3">
                            <div className="col-md-6">
                              ...
                              <p className="fs-15">
                                <span className="fs-14 fw-bold text-gray-9">Total :</span> $9100
                              </p>
                            </div>
                            <div className="col-md-6">
                              <p className="fs-15 mb-1">
                                <span className="fs-14 fw-bold text-gray-9">Customer :</span> Antonio
                              </p>
                              <p className="fs-15">
                                <span className="fs-14 fw-bold text-gray-9">Date :</span> 23 Dec 2024 13:39:11
                              </p>
                            </div>
                          </div>
                        </div>
          ...
          <div className="modal-content">
            <div className="modal-body p-0">
              ...
              <div className="success-wrap scan-wrap text-center">
                ...
                <p className="mb-3">Scan your Phone or UPI App to Complete the payment</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* /Discount */}
      {/* Cash Payment */}
      <div className="modal fade modal-default" id="cash-payment" aria-labelledby="payment-completed">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-body p-0">
              <div className="success-wrap">
                ...
                <div className="resend-form mb-3">
                  <input type="text" className="form-control" defaultValue="infocustomer@example.com" />
                  <button type="button" data-bs-dismiss="modal" className="btn btn-primary btn-xs">
                    Resend Email
                  </button>
                </div>
                <div className="d-flex align-items-center justify-content-center gap-2 flex-wrap">
                  <button type="button" className="btn btn-md btn-light flex-fill" data-bs-toggle="modal" data-bs-target="#print-receipt">
      ...
      {/* /Card Payment */}
      {/* Active Gift Card */}
      <div className="modal fade pos-modal" id="gift-payment" tabIndex={-1} aria-hidden="true">
        <div className="modal-dialog modal-md modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-header">
            ...
            <div className="modal-body pb-1">
              ...
              <div className="resend-form mb-3">
                <input type="text" className="form-control" placeholder="Scan Barcode / Enter Number" />
                <button
                  type="button"
                  data-bs-dismiss="modal"
      ...
      {/* /Active Gift Card */}
      {/* Redeem Value */}
      <div className="modal fade pos-modal" id="redeem-value" tabIndex={-1} aria-hidden="true">
        <div className="modal-dialog modal-md modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-header">
            ...
            <form>
              <div className="modal-body">
                <div className="bg-info-transparent p-2 br-8 mb-3">
                  <p className="text-info">Balance isn’t enough to pay, you can still make a partial payment</p>
                </div>
                ...
                <div className="bg-danger-transparent p-2 mb-3 br-5 border-start border-danger d-flex align-items-center">
                  ...
                  <p className="fs-16 text-gray-9">Available gift card balance : $45.56</p>
                </div>
                <div>
                  <input type="text" className="form-control" placeholder="Enter Bill Amount" />
                </div>
              </div>
              <div className="modal-footer d-flex justify-content-end gap-2 flex-wrap">
                <button type="button" className="btn btn-md btn-secondary" data-bs-dismiss="modal">
      ...
      {/* /Redeem Value */}
      {/* Redeem Value */}
      <div className="modal fade pos-modal" id="redeem-fullpayment" tabIndex={-1} aria-hidden="true">
        <div className="modal-dialog modal-md modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Redeem Value</h5>
      ...
      {/* /Redeem Value */}
      {/* Barcode */}
      <div className="modal fade pos-modal" id="barcode" tabIndex={-1} aria-hidden="true">
        <div className="modal-dialog modal-md modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-header">
            ...
            <form>
              <div className="modal-body">
                <div className="mb-3">
                  <input type="text" className="form-control" placeholder="Enter Barcode of the Product" />
                </div>
                <div className="card bg-light shadow-none border-0 br-0 mb-0">
                  <div className="card-body d-flex align-items-center justify-content-between">
                    ...
                    <div className="qty-item m-0">
                      ...
                      <input type="text" className="form-control text-center" name="qty" defaultValue={4} />
                      <Link
                        to="#"
      ...
      {/* /Barcode */}
      {/* Split Payment */}
      <div className="modal fade pos-modal" id="split-payment" tabIndex={-1} aria-hidden="true">
        <div className="modal-dialog modal-md modal-dialog-centered modal-lg" role="document">
          <div className="modal-content">
            <div className="modal-header">
                ...
                <div className="row">
                  ...
                  <div className="col-md-4">
                    <div className="change-item mb-3">
                      ...
                      <div className="input-icon-start position-relative">
                        ...
                        <input type="text" className="form-control" defaultValue={0.0} />
                      </div>
                    </div>
                  ...
                  <div className="col-md-12">
                      ...
                      <div className="d-flex align-items-center flex-wra gap-4">
                        ...
                        <div className="d-flex align-items-center flex-wrap gap-3">
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash1" defaultChecked />
                            <label className="btn btn-white" htmlFor="cash1">
                              10
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash2" />
                            <label className="btn btn-white" htmlFor="cash2">
                              20
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash3" />
                            <label className="btn btn-white" htmlFor="cash3">
                              50
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash4" />
                            <label className="btn btn-white" htmlFor="cash4">
                              100
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash5" />
                            <label className="btn btn-white" htmlFor="cash5">
                              500
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash6" />
                    ...
                    <div className="point-wrap payment-content mb-3">
                      <div className=" bg-success-transparent d-flex align-items-center justify-content-between flex-wrap p-2 gap-2 br-5">
                        <h6 className="fs-14 fw-bold text-success">You have 2000 Points to Use</h6>
                  ...
                  <div className="col-md-12">
                    <div className="mb-3">
                      ...
                      <textarea className="form-control" rows={3} placeholder="Type your message" defaultValue={''} />
                    </div>
                  </div>
                  <div className="col-md-12">
                    <div className="mb-3">
                  ...
                  <div className="col-md-12">
                    ...
                    <div className="quick-cash payment-content bg-light  mb-3">
                      <div className="d-flex align-items-center flex-wra gap-4">
                        ...
                        <div className="d-flex align-items-center flex-wrap gap-3">
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash11" defaultChecked />
                            <label className="btn btn-white" htmlFor="cash11">
                              10
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash12" />
                            <label className="btn btn-white" htmlFor="cash12">
                              20
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash13" />
                            <label className="btn btn-white" htmlFor="cash13">
                              50
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash14" />
                            <label className="btn btn-white" htmlFor="cash14">
                              100
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash15" />
                            <label className="btn btn-white" htmlFor="cash15">
                              500
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash16" />
                  ...
                  <div className="col-md-12">
                    ...
                    <div className="quick-cash payment-content bg-light  mb-3">
                      <div className="d-flex align-items-center flex-wra gap-4">
                        ...
                        <div className="d-flex align-items-center flex-wrap gap-3">
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash21" defaultChecked />
                            <label className="btn btn-white" htmlFor="cash21">
                              10
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash22" />
                            <label className="btn btn-white" htmlFor="cash22">
                              20
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash23" />
                            <label className="btn btn-white" htmlFor="cash23">
                              50
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash24" />
                            <label className="btn btn-white" htmlFor="cash24">
                              100
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash25" />
                            <label className="btn btn-white" htmlFor="cash25">
                              500
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash26" />
                  ...
                  <div className="col-md-12">
                    ...
                    <div className="quick-cash payment-content bg-light  mb-3">
                      <div className="d-flex align-items-center flex-wra gap-4">
                        ...
                        <div className="d-flex align-items-center flex-wrap gap-3">
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash31" defaultChecked />
                            <label className="btn btn-white" htmlFor="cash31">
                              10
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash32" />
                            <label className="btn btn-white" htmlFor="cash32">
                              20
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash33" />
                            <label className="btn btn-white" htmlFor="cash33">
                              50
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash34" />
                            <label className="btn btn-white" htmlFor="cash34">
                              100
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash35" />
                            <label className="btn btn-white" htmlFor="cash35">
                              500
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash36" />
                  ...
                  <div className="col-md-12">
                    ...
                    <div className="quick-cash payment-content bg-light  mb-3">
                      <div className="d-flex align-items-center flex-wra gap-4">
                        ...
                        <div className="d-flex align-items-center flex-wrap gap-3">
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash41" defaultChecked />
                            <label className="btn btn-white" htmlFor="cash41">
                              10
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash42" />
                            <label className="btn btn-white" htmlFor="cash42">
                              20
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash43" />
                            <label className="btn btn-white" htmlFor="cash43">
                              50
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash44" />
                            <label className="btn btn-white" htmlFor="cash44">
                              100
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash45" />
                            <label className="btn btn-white" htmlFor="cash45">
                              500
                            </label>
                          </div>
                          <div className="form-check">
                            <input type="radio" className="btn-check" name="cash" id="cash46" />
      ...
      {/* /Payment Point */}
      {/* Calculator */}
      <div className="modal fade pos-modal" id="calculator" tabIndex={-1} aria-hidden="true">
        <div className="modal-dialog modal-md modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-body p-0" onKeyDown={handleKeyPress}>
              <div className="calculator-wrap">
                <div className="p-3">
                  ...
                  <div>
                    <input className="input" type="text" placeholder="0" value={input} readOnly />
                  </div>
                </div>
                <div className="calculator-body d-flex justify-content-between">
                  ...
                  <div className="text-center">
                    ...
                    <button className="btn btn-number" onClick={() => handleButtonClick('7')}>
                      7
                    </button>
                    <button className="btn btn-number" onClick={() => handleButtonClick('4')}>
                      4
                    </button>
                    <button className="btn btn-number" onClick={() => handleButtonClick('1')}>
                      1
                    </button>
                    <button className="btn btn-number" onClick={() => handleButtonClick(',')}>
                      ,
                    </button>
                  </div>
                  ...
                  {/* Column 2 */}
                  <div className="text-center">
                    <button className="btn btn-expression" onClick={() => handleButtonClick('/')}>
                      ÷
                    </button>
                    <button className="btn btn-number" onClick={() => handleButtonClick('8')}>
                      8
                    </button>
                    <button className="btn btn-number" onClick={() => handleButtonClick('5')}>
                      5
                    </button>
                    <button className="btn btn-number" onClick={() => handleButtonClick('2')}>
                      2
                    </button>
                    <button className="btn btn-number" onClick={() => handleButtonClick('00')}>
                      00
                    </button>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <button className="btn btn-number" onClick={() => handleButtonClick('9')}>
                      9
                    </button>
                    <button className="btn btn-number" onClick={() => handleButtonClick('6')}>
                      6
                    </button>
                    <button className="btn btn-number" onClick={() => handleButtonClick('3')}>
                      3
                    </button>
                    <button className="btn btn-number" onClick={() => handleButtonClick('.')}>
                      .
      ...
      <div className="modal fade pos-modal" id="cash-register" tabIndex={-1} aria-hidden="true">
        <div className="modal-dialog modal-md modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-header">
      ...
      {/* /Cash Register Details */}
      {/* Today&apos;s Sale */}
      <div className="modal fade pos-modal" id="today-sale" tabIndex={-1} aria-hidden="true">
        <div className="modal-dialog modal-md modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-header">
      ...
      {/* /Today&apos;s Sale */}
      {/* Today&apos;s Profit */}
      <div className="modal fade pos-modal" id="today-profit" tabIndex={-1} aria-hidden="true">
        <div className="modal-dialog modal-md modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-header">
