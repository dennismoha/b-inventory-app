        ...
        <ul className="nav user-menu">
          ...
          <li className="nav-item time-nav">
            <span className="bg-teal text-white d-inline-flex align-items-center">
              <img src="/assets/img/icons/clock-icon.svg" alt="img" className="me-2" />
              {/* 09:25:32  */}
          ...
          {/* <li className="nav-item dropdown has-arrow main-drop select-store-dropdown">
            <Link to="#" className="dropdown-toggle nav-link select-store" data-bs-toggle="dropdown">
              <span className="user-info">
                <span className="user-letter">
                  <img src="src/assets/img/store/store-01.png" alt="Store Logo" className="img-fluid" />
                </span>
            ...
            <div className="dropdown-menu dropdown-menu-right">
              ...
              <Link to="#" className="dropdown-item">
                <img src="src/assets/img/store/store-02.png" alt="Store Logo" className="img-fluid" />
                Grocery Apex
              </Link>
              <Link to="#" className="dropdown-item">
                <img src="src/assets/img/store/store-03.png" alt="Store Logo" className="img-fluid" />
                Grocery Bevy
              </Link>
              <Link to="#" className="dropdown-item">
                <img src="src/assets/img/store/store-04.png" alt="Store Logo" className="img-fluid" />
                Grocery Eden
              </Link>
            </div>
          </li> */}
          ...
          <li className="nav-item dropdown has-arrow main-drop profile-nav">
            ...
            <div className="dropdown-menu menu-drop-user">
              <div className="profilename">
                ...
                <Link className="dropdown-item logout pb-0" to={all_routes.signin}>
