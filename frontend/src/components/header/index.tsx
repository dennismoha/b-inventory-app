...
const Header = () => {
  ...
  useEffect(() => {
    ...
    const handleMouseover = (e: MouseoverEvent) => {
      ...
      const toggleBtn: HTMLElement | null = document.getElementById('toggle_btn');
  ...
  const { expandMenus } = useSelector((state: RootState) => state.themeSetting.expandMenus);
  const dataLayout = useSelector((state: RootState) => state.themeSetting.dataLayout);
        ...
        <div className="main-header">
          ...
          >
            ...
            <Link
              ...
              to="#"
              style={{
                display: pathname.includes('tasks') || pathname.includes('pos') ? 'none' : pathname.includes('compose') ? 'none' : ''
              }}
                        ...
                        <div className="media d-flex">
                          ...
                          <div className="flex-grow-1">
                            <p className="noti-details">
                              <span className="noti-title">James Kirwin</span> confirmed his order. Order No: #78901.Estimated delivery: 2
                              days
                            </p>
