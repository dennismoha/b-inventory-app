...
class AccountRoutes {
    ...
    public routes(): Router {
        ...
        this.router.get(
            ...
            authMiddleware.verifyUser,
            AccountController.prototype.getTrialBalance);

        // Get all accounts
        this.router.get(
            '/accounts',
            authMiddleware.verifyUser,
            AccountController.prototype.getAccounts
        );

        // top up account
        this.router.put('/accounts/topup/:accountId', authMiddleware.verifyUser, createValidatePosSessionMiddleware(), AccountController.prototype.topUp);

        // Get account by ID
        this.router.get(
            '/accounts/:accountId',
            authMiddleware.verifyUser,
            AccountController.prototype.getAccountById
        );
